...
const NewsUpdates = () => {
  ...
  useEffect(() => {
    ...
    sanityClient
      .fetch(
        `*[_type == "newsAndUpdates"] | order(date desc) {
          _id,
          title,
          content,
          date,
  ...
  return (
    <div className="min-h-screen flex flex-col bg-black">
      <NavBar />
      <section className="flex-grow py-24 px-6 md:px-12 lg:px-20 bg-gradient-to-b from-gray-900 to-black">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-white mb-12 text-center">
            News & Updates
            <div className="h-1 w-56 bg-red-600 mx-auto mt-2" />
          </h2>
